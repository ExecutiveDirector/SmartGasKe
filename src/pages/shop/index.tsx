...
// FULL VERSION — PROFESSIONAL SHOP PAGE
// ============================================================
...
const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50">
      ...
      <div className="relative max-w-2xl mx-auto px-2 py-2">
